// src/components/product_detail/filter_card/sections/PriceDetails.tsx
        ...
        <div className="text-sm">
          {priceBasedOnRange.seasonalNight ? (
            <div className="flex justify-between">
              ...
              <div>
                {`${priceBasedOnRange.seasonalNight} x ${toCurrency(
                  priceBasedOnRange.seasonalPrice
                )}`}
              </div>
            </div>
          ) : null}
          ...
          {priceBasedOnRange.normalNight ? (
            <div className="flex justify-between">
              ...
              <div>
                {`${priceBasedOnRange.normalNight} x ${toCurrency(
                  priceBasedOnRange.normalPrice
                )}`}
              </div>
            </div>
          ) : null}
