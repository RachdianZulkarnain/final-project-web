...
const LoginPage = () => {
  ...
  return (
    <SessionProvider>
      <div className="min-h-screen bg-gradient-to-br from-[#0290d185] to-blue-50 flex justify-center items-center px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        <Card className="w-full max-w-2xl shadow-lg rounded-2xl">
          <CardHeader className="text-center">
            <CardTitle className="text-3xl sm:text-4xl font-extrabold text-[#0290d1]">
              Welcome back!
            </CardTitle>
          </CardHeader>
